 ...
 * @author alexandra
 */
public class Riassuntovolo2 extends JPanel {
    ...
    public Riassuntovolo2(HomeFrame home, ControllerClient controller) {
        this.home = home;
  ...
  this.add( pasto, new GridBagConstraints( 2, 4, 1, 1, 1.0,1.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets( 0, 0, 0, 0 ), 200, 40 ) );
    */
   this.add(sunto,new GridBagConstraints( 0, 2, 2, 5, 2.0,5.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets( 0, 0, 0, 0 ), 50, 40 ) );
  this.add( stampa, new GridBagConstraints( 0, 5, 1, 1, 1.0,1.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets( 0, 0, 0, 0 ), 50, 40 ) );
  this.add( conferma, new GridBagConstraints( 2, 5, 1, 1, 1.0,1.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets( 0, 0, 0, 0 ), 200, 40 ) );
   ...
   // }
    ...
    pane.add(bagaglio, c);
     ...
     nbagagli.setText("0");
        ...
        ImageIcon immagine=new ImageIcon("gui/HoldLuggage.png");
